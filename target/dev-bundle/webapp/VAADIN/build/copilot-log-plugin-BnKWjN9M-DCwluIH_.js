import { L as Ll, t as tr, z as zr, U as Ut, M as Ml, s as ss, C as Cs, $, Q as Qt, h as hs } from "./indexhtml-BRa8D7LS.js";
...
class b {
  constructor() {
    this.showTimestamps = false, Qt(this);
  }
...
let r = class extends o {
  ...
  catchErrors() {
    ...
    window.Vaadin.ConsoleErrors = {
      push: (t) => {
        tr.attentionRequiredPanelTag = y.tag, t[0].type !== void 0 && t[0].message !== void 0 ? this.log(t[0].type, t[0].message, !!t[0].internal, t[0].details, t[0].link) : this.log(zr.ERROR, t.map((a) => this.format(a)).join(" "), false), e.push(t);
      }
    };
  }
  render() {
  ...
  renderMessage(e) {
    let t, a, o2;
    return e.type === zr.ERROR ? (t = "error", o2 = r$1.exclamationMark, a = "Error") : e.type === zr.WARNING ? (t = "warning", o2 = r$1.warning, a = "Warning") : (t = "info", o2 = r$1.info, a = "Info"), e.internal && (t += " internal"), Ut`
