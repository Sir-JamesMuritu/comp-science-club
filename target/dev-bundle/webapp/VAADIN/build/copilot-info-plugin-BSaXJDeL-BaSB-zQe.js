import { G as Gl, b as b$1, U as Ut, z as zr, O as O$1, C as Cs, $, y as yl, a as Cl, T as Tl, c as Ur, h as hs } from "./indexhtml-BRa8D7LS.js";
import { g as g$1 } from "./state-DPJamuGL-DTrBXV8o.js";
import { o } from "./base-panel-BQhHDiWH-DbiBOvS0.js";
import { showNotification as N$1 } from "./copilot-notification-ov4Kfahu-RufFw3TU.js";
...
let f = class extends o {
  ...
  updateIdePluginInfo() {
    ...
    let t = "false", a;
    b$1.idePluginState?.active ? t = `${b$1.idePluginState.version}-${b$1.idePluginState.ide}` : b$1.idePluginState?.ide === "vscode" ? a = w : b$1.idePluginState?.ide === "idea" ? a = b : a = Ut`${b} or ${w}`, this.serverInfo[e].version = t, this.serverInfo[e].more = a;
  }
  getIndex(e) {
...
`);
  ...
  renderJavaHotswap() {
    ...
    return !e.extendedClassDefCapable && !t ? Ut`<details>
      ...
      </details>` : t ? Ut`${d(true)} JRebel is in use` : e.activeHotswap === "hotswapagent" ? Ut`${d(true)} HotswapAgent is in use` : Ut`<details>
      ...
      <ul style="margin:0;padding:0">
        ...
        <li>
          ...
          enabled${e.runningWithExtendClassDef ? O$1 : Ut`<br />Add the <code>-XX:+AllowEnhancedClassRedefinition</code> JVM argument when launching the
                application`}
        </li>
        <li>
          ${d(e.hotswapAgentFound)} HotswapAgent
          installed${e.hotswapAgentFound ? O$1 : Ut`<br /><a target="_blank" href="https://github.com/HotswapProjects/HotswapAgent/releases"
        ...
        <li>
          ...
          ${e.runningWitHotswap ? O$1 : Ut`<br />Add the <code>-XX:HotswapAgent=fatjar</code> JVM argument when launching the application`}
        </li>
        <li>
          ${d(e.hotswapAgentPluginsFound)} Vaadin HotswapAgent plugin available
          ${e.hotswapAgentPluginsFound ? O$1 : Ut`<div>
        ...
        <li>
          ...
          ${e.runningInJavaDebugMode ? O$1 : Ut`<div>Start the application in debug mode in the IDE</div>`}
        </li>
      </ul>
    </details> `;
  }
