package com.computerscience.views.membersgroup;
...
@PageTitle("Members Group")
@Route(value = "Members-Group", layout = MainLayout.class)
@RolesAllowed("USER")
public class MembersGroupView extends HorizontalLayout {
    ...
    public MembersGroupView() {
        addClassNames("members-group-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
