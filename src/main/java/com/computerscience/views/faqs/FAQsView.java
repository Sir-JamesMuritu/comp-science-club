package com.computerscience.views.faqs;
...
@PageTitle("FAQs")
@Route(value = "FAQs", layout = MainLayout.class)
@AnonymousAllowed
public class FAQsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public FAQsView() {
        addClassName("f-a-qs-view");
        setSizeFull();
        grid.setHeight("100%");
