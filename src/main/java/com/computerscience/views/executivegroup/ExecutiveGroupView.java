package com.computerscience.views.executivegroup;
...
@PageTitle("Executive Group")
@Route(value = "Executive-Group", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class ExecutiveGroupView extends HorizontalLayout {
    ...
    public ExecutiveGroupView() {
        addClassNames("executive-group-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
